...
$stmt->bindValue(':uid', $suid,PDO::PARAM_STR);
$status = $stmt->execute();
...
$stmt->bindValue(':id', $suid,PDO::PARAM_STR);
$status = $stmt->execute();
...
$view  = '<a href="../tl/tl_answer.php?id='.h($sid).'">';
$view .= "提案内容に戻る";
$view .= '</a>';
    ...
    <div class="container menu">
        ...
        <div class="menu_detail">
            ...
            <input type="hidden" name="action" value="submit"/>
                <label><p class="subtitle">名前：</p><p class="subdetail"><?php echo h($sname); ?></p></label><br>
                <label><p class="subtitle">email：</p><p class="subdetail"><?php echo h($email); ?></p></label><br>

                <label><p class="subtitle">イメージ：
                </p><p class="subdetail"><p class="subtitle"><?php echo '<img src="../img/'.h($image).'">'; ?></p></label><br>
